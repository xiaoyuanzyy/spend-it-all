...
// ==================== 富豪数据 ====================
const billionaires = [
  { _id: '0',  name: '富军',   nationality: '中国', companies: ['阿里巴巴', '蚂蚁集团', '菜鸟网络'], assets: 250000000000, tags: ['商业奇才', '武侠迷', '教育家'],     catchphrase: '让天下没有难做的生意', avatar: '', matchTags: ['科技', '地产', '金融', '教育', '艺术', '收藏', '运动', '时尚'] },
  { _id: '1',  name: '马斯克', nationality: '美国', companies: ['特斯拉', 'SpaceX', 'X', 'xAI', 'Neuralink'], assets: 250000000000, tags: ['疯狂创新者', '推特整活', '火星人'], catchphrase: '让人类成为多星球物种', avatar: '', matchTags: ['科技', '太空', '汽车', '旅行', '金融', '收藏', '珠宝', '地产'] },
  { _id: '2',  name: '特朗普', nationality: '美国', companies: ['特朗普集团', 'Truth Social'], assets: 6500000000, tags: ['懂王', '地产大亨', '真人秀明星'],        catchphrase: '让美国再次伟大', avatar: '', matchTags: ['地产', '金融', '奢华', '炫富', '时尚', '珠宝', '美食', '汽车'] },
  { _id: '3',  name: '丁磊',   nationality: '中国', companies: ['网易', '网易云音乐', '严选'], assets: 35000000000, tags: ['网易掌门', '养猪达人', '品味生活'],       catchphrase: '以创新和品味改变生活', avatar: '', matchTags: ['科技', '美食', '家居', '音乐', '教育', '宠物', '艺术', '健康'] },
  { _id: '4',  name: '张一鸣', nationality: '中国', companies: ['字节跳动', 'TikTok', '抖音'], assets: 45000000000, tags: ['算法之王', '全球扩张', '延迟满足'],       catchphrase: '构建全球信息分发', avatar: '', matchTags: ['科技', '金融', '教育', '艺术', '旅行', '音乐', '时尚', '健康'] },
  { _id: '5',  name: '马云',   nationality: '中国', companies: ['阿里巴巴', '蚂蚁集团', '菜鸟'], assets: 25000000000, tags: ['风清扬', '武侠迷', '教育家'],           catchphrase: '让天下没有难做的生意', avatar: '', matchTags: ['地产', '金融', '教育', '艺术', '运动', '收藏', '旅行', '科技'] },
  { _id: '6',  name: '黄峥',   nationality: '中国', companies: ['拼多多', 'Temu'], assets: 35000000000, tags: ['拼多多王', '下沉市场', '退而不休'],       catchphrase: 'Costco + Disney', avatar: '', matchTags: ['科技', '日用品', '美食', '时尚', '家居', '宠物', '健康', '汽车'] },
  { _id: '7',  name: '马化腾', nationality: '中国', companies: ['腾讯', '微信', 'Riot Games'], assets: 40000000000, tags: ['企鹅帝国', '产品经理之王', '低调务实'],   catchphrase: '连接一切', avatar: '', matchTags: ['科技', '金融', '音乐', '艺术', '收藏', '时尚', '太空', '教育'] },
  { _id: '8',  name: '贝佐斯', nationality: '美国', companies: ['亚马逊', 'Blue Origin', '华盛顿邮报'], assets: 180000000000, tags: ['电商之王', '太空梦想家', '光头战神'], catchphrase: '每一天都是第一天', avatar: '', matchTags: ['科技', '太空', '地产', '金融', '旅行', '汽车', '收藏', '奢华'] },
  { _id: '9',  name: '扎克伯格', nationality: '美国', companies: ['Meta', 'Facebook', 'Instagram', 'WhatsApp'], assets: 120000000000, tags: ['社交之王', '元宇宙信徒', '格斗爱好者'], catchphrase: '快速行动，打破常规', avatar: '', matchTags: ['科技', '运动', '时尚', '旅行', '家居', '健康', '教育', '艺术'] },
  { _id: '10', name: '盖茨',   nationality: '美国', companies: ['微软', '盖茨基金会', 'TerraPower'], assets: 130000000000, tags: ['软件之父', '慈善大师', '读书狂人'],   catchphrase: '成功是一位糟糕的老师', avatar: '', matchTags: ['科技', '教育', '收藏', '健康', '旅行', '艺术', '金融', '太空'] },
  { _id: '11', name: '巴菲特', nationality: '美国', companies: ['伯克希尔·哈撒韦', '可口可乐', '苹果'], assets: 120000000000, tags: ['股神', '价值投资', '可乐狂魔'],     catchphrase: '别人贪婪时我恐惧', avatar: '', matchTags: ['金融', '美食', '收藏', '地产', '日用品', '汽车', '名酒', '奢华'] },
  { _id: '12', name: '李嘉诚', nationality: '中国', companies: ['长江集团', '和记黄埔', '屈臣氏'], assets: 38000000000, tags: ['超人', '地产之王', '低调富豪'],           catchphrase: '无论风吹浪打都前进', avatar: '', matchTags: ['地产', '金融', '日用品', '旅行', '健康', '科技', '家居', '收藏'] },
  { _id: '13', name: '王健林', nationality: '中国', companies: ['万达集团', '万达广场', '万达影业'], assets: 15000000000, tags: ['地产巨鳄', '先赚一个亿', '万达之魂'],     catchphrase: '先定一个小目标', avatar: '', matchTags: ['地产', '影视', '旅行', '运动', '收藏', '奢华', '汽车', '名酒'] },
  { _id: '14', name: '任正非', nationality: '中国', companies: ['华为', '海思', '鸿蒙'], assets: 3500000000, tags: ['硬汉', '民族脊梁', '技术狂魔'],                      catchphrase: '除了胜利，别无选择', avatar: '', matchTags: ['科技', '教育', '健康', '艺术', '珠宝', '地产', '金融', '旅行'] },
  { _id: '15', name: '雷军',   nationality: '中国', companies: ['小米', '金山', '顺为资本'], assets: 15000000000, tags: ['Are you OK', '性价比之王', '劳模'],             catchphrase: '站在风口上，猪都能飞', avatar: '', matchTags: ['科技', '日用品', '家居', '运动', '汽车', '时尚', '宠物', '健康'] },
  { _id: '16', name: '刘强东', nationality: '中国', companies: ['京东', '京东物流', '京东科技'], assets: 12000000000, tags: ['东哥', '兄弟文化', '物流之王'],               catchphrase: '不会自建物流就不是好电商', avatar: '', matchTags: ['科技', '地产', '旅行', '汽车', '日用品', '金融', '美食', '健康'] },
  { _id: '17', name: '蔡崇信', nationality: '中国', companies: ['阿里巴巴', '篮网队', '蓝池资本'], assets: 10000000000, tags: ['隐形军师', '律师出身', '体育投资人'],       catchphrase: '放弃高薪拥抱梦想', avatar: '', matchTags: ['运动', '金融', '艺术', '音乐', '旅行', '时尚', '收藏', '地产'] },
  { _id: '18', name: '钟睒睒', nationality: '中国', companies: ['农夫山泉', '万泰生物'], assets: 65000000000, tags: ['首富', '低调神秘', '瓶装水之王'],                    catchphrase: '我们不生产水，我们只是大自然的搬运工', avatar: '', matchTags: ['日用品', '健康', '美食', '旅行', '家居', '宠物', '科技', '收藏'] },
  { _id: '19', name: '库克',   nationality: '美国', companies: ['苹果', 'Apple Watch', 'Vision Pro'], assets: 2000000000, tags: ['供应链大师', '出柜CEO', '素食主义者'],    catchphrase: 'Think Different', avatar: '', matchTags: ['科技', '时尚', '健康', '音乐', '艺术', '旅行', '家居', '运动'] }
];
